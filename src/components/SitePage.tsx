        ...
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <button
              ...
              className="flex md:hidden items-center gap-2 px-3 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-[9px] uppercase tracking-widest font-bold hover:bg-primary/20 transition-all"
