    ...
    <>
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <button
            className="fixed right-4 top-4 z-50 p-3 rounded-full backdrop-blur-md border border-white/20 shadow-lg transition-all hover:scale-110"
            style={{ backgroundColor: siteConfig.colors.primary + 'CC' }}
            title="Admin Panel"
          >
